...
.btn{
  ...
  <center>  
    ...
    <br>
     ...
     <?php 
        $records1 = mysqli_query($con,"select * from storetable WHERE id='$mallid'");
        $data1 = mysqli_fetch_array($records1);

        echo $data1['city'];
        echo '<br>';
        echo $data1['store_name'];
        echo '<br>';
        echo $data1['location'];
        echo '<br>';
  ...
  <?php
        ...
        $records = mysqli_query($con,"select * from current WHERE mall_id='$mallid'"); // fetch data from database
