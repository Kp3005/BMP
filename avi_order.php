...
<?php
    $records = mysqli_query($con,"select * from order_pick where delivery_type = 1 && delivery_status = 0"); // fetch data from database
        ...
        if(mysqli_num_rows($records) <1){
            ...
            <h1><center>No Orders To be delivered!</center></h1>
            </div>';
  ...
  <?php
        ...
        <tr>
           ...
           ?> 
            ...
            <td>
                <a href="dl_accept.php?see=<?php echo $data['token']; ?>" class="btn"> accept </a>
            </td>
        </tr>	
        <?php
        }
